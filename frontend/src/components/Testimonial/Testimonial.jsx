            ...
            <SwiperSlide>
                <div className='py-40px px-6 rounded-3'>
                    <div className='flex items-center gap-13px mt-10px'>
                        ...
                        <div>
                            <h4 className='text-18px leading-30px font-semibold text-headingColor ml-2 '> Akash rhaeja</h4>
                    ...
                    <p className='text-[16px] leading-7 mt-4 text-textColor font-400'>I have taken medical service from them. They treat so well and they are providing the best medical services.</p>
                </div>
            </SwiperSlide>
            <SwiperSlide>
